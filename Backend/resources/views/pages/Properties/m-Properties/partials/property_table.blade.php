            ...
            <tr class="hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200 cursor-pointer border-b border-gray-300 property-table-row">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                    <div class="flex justify-center items-left space-x-3">
                        <!-- View — dispatches event to page-level modal -->
                        <div class="relative group">
                            ...
                            <button
                                ...
                                type="button"
                                @click.prevent='$dispatch("open-property-view-modal", {
                        ...
                        {{-- View modal moved to page level (index.blade.php) to escape backdrop-filter clipping --}}
                                                                ...
                                                                <div class="relative">
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <div class="flex-1 overflow-hidden">
                                                                            <span
                                                                                class="block break-words">{{ \App\Helpers\DescriptionHelper::get($facility->facility, app()->getLocale()) }}</span>
