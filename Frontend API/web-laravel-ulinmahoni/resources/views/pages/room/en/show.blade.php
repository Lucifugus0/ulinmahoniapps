                        ...
                        <form id="bookingForm" class="space-y-6" method="POST" action="{{ route('bookings.store') }}" novalidate>
                                ...
                                <div id="availabilityStatus" class="text-sm p-3 rounded-lg border border-gray-200 bg-gray-50 transition-all duration-300">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-gray-600 font-medium">Availability Status:</span>
                                        </div>
                                        <span class="text-xs text-gray-500">Waiting for date selection...</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            @auth
                                <div id="rentalAgreementSection" class="hidden mb-4">
                                    ...
                                    <div id="agreementError" class="hidden mt-2 text-sm text-red-600">
                                        <p><i class="fas fa-exclamation-circle mr-1"></i>You must agree to the Rental Agreement to continue.</p>
                                    </div>
                                </div>
                            @endauth
                            ...
                            <div>
                                @guest
                                    ...
                                    <p class="text-sm text-gray-500 text-center mt-2">Please log in or register to make a booking</p>
                                @else
    ...
    <script>
        ...
        function showAvailabilityStatus(type, message) {
            ...
            if (type === 'unavailable' && message && message.includes('pemesanan konflik')) {
                ...
                if (match) {
                    const count = match[1];
                    statusMessage = `Room already booked`;
                }
            }
